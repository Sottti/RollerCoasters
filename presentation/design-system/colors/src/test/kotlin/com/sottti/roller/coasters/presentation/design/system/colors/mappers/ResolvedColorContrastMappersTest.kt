package com.sottti.roller.coasters.presentation.design.system.colors.mappers
...
internal class ResolvedColorContrastMappersTest {
    ...
    fun `standard contrast maps to dark standard contrast scheme`() {
        ...
        assertThat(result).isEqualTo(darkStandardContrastScheme)
    }
    ...
    fun `standard contrast maps to light standard contrast scheme`() {
        ...
        assertThat(result).isEqualTo(lightStandardContrastScheme)
    }
