...
public fun SdkLevel.isAtLeastSdk29(): Boolean = value >= Build.VERSION_CODES.Q

@ChecksSdkIntAtLeast(api = Build.VERSION_CODES.Q)
public fun isAtLeastSdk29(): Boolean = SdkLevel(Build.VERSION.SDK_INT).isAtLeastSdk29()

public fun isBelowSdk31(): Boolean = !isAtLeastSdk31()

public fun isBelowSdk29(): Boolean = !isAtLeastSdk29()