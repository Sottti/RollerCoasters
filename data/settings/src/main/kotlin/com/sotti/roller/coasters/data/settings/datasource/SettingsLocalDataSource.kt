package com.sotti.roller.coasters.data.settings.datasource
...
import com.sotti.roller.coasters.data.settings.managers.LocaleManager
import com.sotti.roller.coasters.data.settings.managers.MeasurementSystemManager
import com.sotti.roller.coasters.data.settings.managers.SystemColorContrastManager
import com.sotti.roller.coasters.data.settings.managers.ThemeManager
import com.sotti.roller.coasters.data.settings.mapper.key
import com.sotti.roller.coasters.data.settings.mapper.toAppColorContrast
import com.sotti.roller.coasters.data.settings.mapper.toAppDynamicColor
import com.sotti.roller.coasters.data.settings.mapper.toAppMeasurementSystem
import com.sotti.roller.coasters.data.settings.mapper.toBoolean
import com.sotti.roller.coasters.data.settings.mapper.toLanguage
import com.sotti.roller.coasters.data.settings.mapper.toLocaleList
import com.sotti.roller.coasters.data.settings.mapper.toTheme
